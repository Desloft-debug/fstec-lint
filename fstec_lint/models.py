...
class Rule:
    ...
    target: str
    orders: str = ""
    # Группа мер методического документа ФСТЭК к приказу N 117. Пустая
    # строка означает, что группы для предмета правила в имеющейся
    # выписке из документа нет — это честнее, чем натянуть ближайшую.
    methodology: str = ""
