...
# 3: адрес находок D002/D005 при усечении получил хвост-хеш полного
# текста команды (две разные длинные команды с общим началом делили один
# адрес и глушились одной записью). Отпечатки этих правил изменились,
# поэтому baseline от 0.8.x нужно перегенерировать — молча пропускать
# половину принятого долга хуже, чем потребовать одну команду.
BASELINE_VERSION = 3
